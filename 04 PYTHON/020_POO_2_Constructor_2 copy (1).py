...
puedes utilizar un constructor vacío si quieres crear una clase que solo tenga 
métodos estáticos o de clase y no necesite mantener ningún estado en sus objetos.        
"""